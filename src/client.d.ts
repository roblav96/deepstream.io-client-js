declare namespace deepstream {
	...
	class Emitter {
		...
		emit(event: string, fn?: Function): this;
		...
		removeAllListeners(event?: string, fn?: Function): this;
	...
	class Client extends Emitter {
		...
		close(): void;
		getConnectionState(): CONSTANTS.CONNECTION_STATE;
		getUid(): any;
		login(authParams: {}, callback?: (success: boolean, data: {}) => void): this;
	}
	...
	// type OnEventArgs = (event: string, fn: Function) => Emitter;
	...
	// deepstream.off() */
	// type OffEventArgs = (event?: string, fn?: Function) => void;

	// interface Emitter {
	// 	on: OnEventArgs;
	// 	addEventListener: OnEventArgs;
	// 	off: OffEventArgs;
	// 	removeEventListener: OffEventArgs;
	// 	removeAllListeners: OffEventArgs;
	// 	removeListener: OffEventArgs;
	...
	// interface Client extends Emitter {
	// 	CONSTANTS: CONSTANTS;
	// 	MERGE_STRATEGIES: MERGE_STRATEGIES;
	...
	// 	*/
	// 	login(authParams?: {}, callback?: (success: boolean, data: {}) => void): Client;
	...
	interface MERGE_STRATEGIES {
		REMOTE_WINS(): void
		LOCAL_WINS(): void
	}

	interface Client extends Client {
		(url: string, options?: Options): Client;
	}

}

declare module 'deepstream.io-client-js' {
	var deepstream: deepstream.Client;
	export = deepstream;
}
